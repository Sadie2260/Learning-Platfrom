      ...
      <div className="container pt-5 banner_wrapper">
        <div className="row">
          <div className='col-md-5 d-flex align-items-center'>
            <div>
            <h1 className='banner-title'>Your Courses to Success</h1>
            <p className='w-75 banner-p pt-4'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
            <button className="tooltip-container mt-4">
  <span className="tooltip"><span style={{marginLeft:"5px"}}>Click to Continue!</span></span>
...
.tooltip-container:hover .tooltip {
  top: calc(-100% - var(--support-size) * -0.1);
  opacity: 1;
  visibility: visible;
  pointer-events: auto;
